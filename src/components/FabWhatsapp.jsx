...
export default function FabWhatsapp() {
  ...
  return (
    <a
      ...
      aria-label="Falar com Corazza no WhatsApp"
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full shadow-xl transition-all duration-500 ease-out
        bg-[#25D366] hover:bg-[#1EBE5D] text-white
        w-14 h-14 md:w-auto md:h-auto md:px-5 md:py-3.5
        justify-center md:justify-start
        ${entered ? 'animate-fab-in' : 'opacity-0 translate-y-10'}
        ${visible ? 'translate-y-0' : 'translate-y-24 pointer-events-none'}
      `}
      style={{

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-5 md:px-8 text-center py-20">
        ...
        {/* Recap pills */}
        <div
          className="inline-flex flex-wrap justify-center gap-3 mb-8 transition-all duration-700 delay-200"
          style={{
            opacity: isVisible ? 1 : 0,
        ...
        >
          <span className="inline-flex h-2.5 w-2.5 rounded-full bg-[#52B788]" />
          <span className="text-white/80 text-sm md:text-base font-medium">
            Sala 2313 disponível
          </span>
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#2D6A4F] hover:bg-[#245a42] text-white font-semibold text-base md:text-lg px-10 py-5 rounded-full shadow-lg transition-all duration-300 hover:-translate-y-0.5"
          style={{
            opacity: isVisible ? 1 : 0,
            transform: isVisible ? 'translateY(0)' : 'translateY(16px)',
        ...
        <p className="mt-10 text-white/30 text-[11px] leading-relaxed max-w-md mx-auto">
